...
def _state_dir() -> Path:
    ...
    # Default: $DIGIT_HOME/watcher-state/, falling back to ~/.digit/watcher-state/.
    digit_home = os.environ.get("DIGIT_HOME") or str(Path.home() / ".digit")
    return Path(digit_home) / "watcher-state"
