...
Data file: $DIGIT_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_DIGIT_HOME = Path(os.environ.get("DIGIT_HOME", Path.home() / ".digit"))
DATA_DIR = _DIGIT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
