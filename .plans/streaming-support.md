# Streaming LLM Response Support for Digit
...
```
DIGIT_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("DIGIT_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `digit_cli/config.py` | 1 | +streaming config defaults |
