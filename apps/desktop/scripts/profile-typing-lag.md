...
cd apps/desktop
XCURSOR_SIZE=24 DIGIT_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/digit-typing
# → /tmp/digit-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/digit-typing.before.heapsnapshot
# → /tmp/digit-typing.after.heapsnapshot
```
