...
/**
 * E2E smoke tests for the packaged Digit desktop app.
 *
 ...
 * (credential stripping, isolated DIGIT_HOME + userData, unique app name).
 *
...
test('window opens with the Digit title', async () => {
