 ...
 * AIAgent loop, using the E2E mock provider configured in `digitHome`.
 *
...
export class RealSessionBuilder {
  ...
  static async start(digitHome: string): Promise<RealSessionBuilder> {
    const builder = new RealSessionBuilder(digitHome)
