...
// even though a fresh shell — and the Digit CLI — sees it immediately. The
// desktop's DIGIT_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\digit. Reading
...
//       DIGIT_HOME    REG_SZ    F:\Digit\data
//
