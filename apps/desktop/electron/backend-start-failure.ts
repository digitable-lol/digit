 ...
 * startDigit() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startDigit() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startDigit`, re-emits
