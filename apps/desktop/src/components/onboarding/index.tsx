...
import { getGlobalModelOptions } from '@/digit'
...
import type { ModelOptionProvider, OAuthProvider } from '@/types/digit'
...
// onboarding / Providers key form lists every `api_key` provider `digit model`
...
const SHOW_ALL_KEY = 'digit-onboarding-show-all-v1'
