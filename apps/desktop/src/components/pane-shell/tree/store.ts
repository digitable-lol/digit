...
const STORAGE_KEY = 'digit.desktop.layoutTree.v2'

writeKey('digit.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('digit.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('digit.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'digit.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'digit.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__DIGIT_LAYOUT_TREE__ = {
    close: closeTreePane,
