/**
 * Digit skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$DIGIT_HOME/skins/` (or a
 * built-in) resolved by `digit_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Digit authors from a prompt lights up all three surfaces from one file.
 *
...
import type { DigitSkin, SkinColors } from '@digit/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: DigitSkin): DesktopTheme | null {
