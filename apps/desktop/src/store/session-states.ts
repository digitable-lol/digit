...
const TILES_KEY = 'digit.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'digit.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __DIGIT_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__DIGIT_SESSION_TILES__ = {
