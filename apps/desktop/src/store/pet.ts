...
export interface PetInfo {
  ...
  // the Digit "run" activity state uses the in-place running row).
 ...
 * DIGIT_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'digit.desktop.pet-roam.v1'
