...
const POPOUT_STORAGE_KEY = 'digit.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'digit.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'digit.desktop.composerPopout.position'
