 ...
 * `src/plugins/` with a `plugin.tsx` that default-exports a `DigitPlugin` is
 ...
 *
 * The ONLY import surface is `@digit/plugin-sdk` (lint-enforced) — the
