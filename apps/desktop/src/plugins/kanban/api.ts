...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@digit/plugin-sdk'
...
/** First-class Digit projects, for scoping a board's default workspace. */
