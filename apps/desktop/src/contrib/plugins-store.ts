 ...
 * `<digit home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'digit.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'digit.desktop.disabledPlugins.v1'
