 ...
 * plugins resolve `@digit/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __DIGIT_PLUGIN_SDK__: sdk,
  __DIGIT_REACT__: React,
  __DIGIT_REACT_JSX__: jsxRuntime,
  __DIGIT_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@digit/plugin-sdk': shimUrl('__DIGIT_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__DIGIT_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__DIGIT_REACT_JSX__'),
    react: shimUrl('__DIGIT_REACT__')
  }
