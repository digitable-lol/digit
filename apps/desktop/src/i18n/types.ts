...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshDigitPathTitle: string
      sshDigitPathDesc: string
      sshDigitPathPlaceholder: string
  ...
  commandCenter: {
    ...
    digitActiveSessions: (version: string, count: number) => string
