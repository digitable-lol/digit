...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        'Unset DIGIT_DESKTOP_REMOTE_URL and DIGIT_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
  ...
  install: {
    ...
    setupChoiceDesc:
      'Connect this app to a Digit gateway you already run, or install Digit locally on this computer.',
