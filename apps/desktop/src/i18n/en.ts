...
export const en: Translations = {
  ...
  boot: {
    ready: 'Digit Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Digit settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingDigitDesktop: 'Starting Digit Desktop…'
    },
    errors: {
      backgroundExited: 'Digit background process exited.',
      backgroundExitedDuringStartup: 'Digit background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Digit backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateDigit: 'Update Digit',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Digit Desktop.',
    ...
    native: {
      ...
      inputBody: 'Digit is waiting for your response.',
      turnDoneTitle: 'Digit finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Digit defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Digit is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Digit asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Digit was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Digit follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Digit can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Digit is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Digit, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Digit checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Digit configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Digit.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Digit backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc: 'Unset DIGIT_DESKTOP_REMOTE_URL and DIGIT_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Digit backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Digit backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Digit Cloud',
      cloudDesc: 'Sign in once to Digit Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Digit Cloud',
      cloudSignIn: 'Sign in to Digit Cloud',
      cloudSignedIn: 'Signed in to Digit Cloud',
      cloudNeedsSignIn: 'Sign in to Digit Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Digit Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Digit Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Digit Cloud',
      cloudSignedOutMessage: 'Cleared the Digit Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /digit.',
      ...
      restartingMessage: 'Digit Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Digit ${version}` : ''}`,
      ...
      sshDesc:
        'Digit is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshDigitPathTitle: 'Digit path (optional)',
      sshDigitPathDesc: 'Full path to the remote digit binary. Blank = auto-detect.',
      sshDigitPathPlaceholder: 'auto-detect',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Digit found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Digit runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update Digit on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Digit runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Digit at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via digit curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Digit builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Digit to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Digit to generate pets.',
      backgroundHint: 'You can close this — Digit will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Digit desktop' },
    ...
    digitActiveSessions: (version, count) => `Digit ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@digit:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Digit environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Digit will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Digit backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Digit. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Digit...',
    placeholderReconnecting: 'Reconnecting to Digit…',
    ...
    attachUrlDesc: 'Digit will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Digit to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Digit…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Digit…',
    ...
    unsupportedMessage: 'This version of Digit can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Digit from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Digit will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Digit desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Digit updater takes over in its own window and reopens Digit automatically when it’s done. Please don’t reopen Digit yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Digit reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Digit reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Digit needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Digit Desktop',
    setupChoiceDesc: 'Connect this app to a Digit gateway you already run, or install Digit locally on this computer.',
    connectExistingTitle: 'Connect to existing Digit',
    ...
    installLocalTitle: 'Install Digit locally',
    installLocalDesc: 'Download Digit, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Digit Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Digit',
    remoteSetupDesc: 'Enter your gateway URL. Digit Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Digit gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/digit',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Digit gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Digit CLI or desktop instance is running. Stop any running Digit instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    ...
    preparingInstall: 'Digit is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Digit…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Digit',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Digit at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Digit connects automatically',
    ...
    authorizeThere: 'Authorize Digit there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Digit there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Digit Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Digit Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Digit will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Digit is restarting...',
      askRestart: 'Ask Digit to restart the server',
      lookingRestart: taskId => `Digit is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Digit is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Digit finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Digit could not restart the server.',
      stillWorking:
        'Digit is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Digit is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Digit gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.digit/config.yaml). Digit won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Digit needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Digit needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Digit Desktop to use Save Image.',
    restartToSaveImages: 'Restart Digit Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `digit gateway` running?'
    }
  },
