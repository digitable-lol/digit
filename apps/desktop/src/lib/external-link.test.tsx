...
function installDesktopBridge(partial: Partial<Window['digitDesktop']> = {}) {
  desktopWindow.digitDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['digitDesktop']
}
...
function installTitleBridge(title: string) {
  ...
  installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['digitDesktop']['fetchLinkTitle'] })
...
describe('external link helpers', () => {
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['digitDesktop']['openExternal'] })
