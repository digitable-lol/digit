...
import { type BillingBlock, skillInvocationText } from '@digit/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/digit'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @digit/shared BillingBlock).
