...
import { getDigitConfigRecord, listAllProfileSessions } from '@/digit'
...
// Digit session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-digit',
            keywords: ['update', 'upgrade', 'digit', 'version', 'system', 'restart'],
            label: cc.updateDigit,
