...
import { type DroppedFile, extractDroppedFiles, DIGIT_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, DIGIT_PATHS_MIME) ? 'files' : null
