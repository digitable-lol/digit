...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/digit'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('digit:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('digit:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Digit to
