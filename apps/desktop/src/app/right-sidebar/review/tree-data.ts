import type { DigitReviewFile } from '@/global'
...
export function buildReviewFlatList(files: DigitReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: DigitReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
