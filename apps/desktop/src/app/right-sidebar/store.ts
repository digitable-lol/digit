...
const TAKEOVER_KEY = 'digit.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Digit can't clear via the API — the user
 *  sees exactly what runs instead of Digit silently deleting their creds. */
