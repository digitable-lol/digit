...
vi.mock('@/digit', () => ({
  saveDigitConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setDigitConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useDigitConfigRecord: () => ({ data: mocks.loadedConfig })
}))
