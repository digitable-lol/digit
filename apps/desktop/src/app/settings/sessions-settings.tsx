...
import type { DigitConfigRecord, SessionInfo } from '@/types/digit'
...
// / Program Files), which buried any files Digit wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.digitDesktop` is
    ...
    const settings = window.digitDesktop?.settings
