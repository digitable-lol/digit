...
import type { ConfigFieldSchema, DigitConfigRecord, ToolsetInfo } from '@/types/digit'
...
export function getNested(obj: DigitConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: DigitConfigRecord, path: string, value: unknown): DigitConfigRecord {
...
function personalityOptions(config: DigitConfigRecord): string[] {
...
function commandProviderNames(config: DigitConfigRecord, section: 'tts' | 'stt'): string[] {
