...
import { saveDigitConfig } from '@/digit'
...
function fontFamilyFromConfig(config: DigitConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useDigitConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<DigitConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setDigitConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="digit-terminal-font-families"
          ...
          <datalist id="digit-terminal-font-families">
