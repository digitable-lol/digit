...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\digit\digit\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@digit/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@digit/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@digit/shared': path.resolve(__dirname, '../shared/src'),
