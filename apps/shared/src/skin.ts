/**
 * Canonical Digit skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$DIGIT_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`digit_cli/skin_engine.py`),
 ...
 *   • CLI     → `digit_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
