...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$DIGIT_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_digit_dir("platforms/whatsapp/session", "whatsapp/session")
