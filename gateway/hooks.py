...
Hooks are discovered from ~/.digit/hooks/ directories, each containing:
...
HOOKS_DIR = get_digit_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"digit_hook_{hook_name}"
