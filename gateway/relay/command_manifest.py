...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Digit session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Digit session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Digit agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Digit to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Digit gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Digit session in it",
