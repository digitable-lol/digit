...
import type { ScrollBoxHandle } from '@digit/ink'
import { evictInkCaches } from '@digit/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.DIGIT_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
