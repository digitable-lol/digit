import type { BillingBlock, UsageModelData } from '@digit/shared/billing'
import type { DigitSkin } from '@digit/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@digit/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = DigitSkin
...
// Wire shapes now live in @digit/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
