import { Box, type ScrollBoxHandle, stringWidth, Text } from '@digit/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (DIGIT_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (DIGIT_DEV_CREDITS), lowest priority,
