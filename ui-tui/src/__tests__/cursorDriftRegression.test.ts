 ...
 *
 * Symptom: in `digit --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@digit/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using digit --tui and as i type multiline my caret at the end will often ' +
