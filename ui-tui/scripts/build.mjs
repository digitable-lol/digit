...
await build({
  ...
  // Skip the prebuilt @digit/ink bundle and inline the source instead:
  ...
  alias: { '@digit/ink': resolve(root, 'packages/digit-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The digit_cli launcher
