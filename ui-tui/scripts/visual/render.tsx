 ...
 * across theme x background scenes to <tmpdir>/digit-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@digit/ink'
...
// The regenerated slate light_colors block from digit_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/digit',
...
const setup = (bgHex: string) => {
  process.env.DIGIT_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
