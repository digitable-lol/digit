 ...
 *
 * Values mirror digit_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Digit default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Digit' default when unset). */
