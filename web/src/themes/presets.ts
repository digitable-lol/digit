 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `digit_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Digit Teal",
  description: "Classic dark teal — the canonical Digit look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Digit Teal (Large)",
  description: "Digit Teal with bigger fonts and roomier spacing",
