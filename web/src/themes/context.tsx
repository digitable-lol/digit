...
const STORAGE_KEY = "digit-dashboard-theme";
...
const FONT_STORAGE_KEY = "digit-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `digit_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "digit-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-digit-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-digit-theme-font", "true");
