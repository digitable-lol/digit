...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateDigit: string;
    updateDigitConfirmMessage?: string;
    updateDigitConfirmNow?: string;
    updateDigitConfirmTitle?: string;
    updatingDigit: string;
  ...
  // ── Achievements plugin (plugins/digit-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
