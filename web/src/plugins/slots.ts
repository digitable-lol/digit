 ...
 * `window.__DIGIT_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Digit brand in the top bar
 ...
 *  `window.__DIGIT_PLUGINS__.registerSlot(...)`.
 *
