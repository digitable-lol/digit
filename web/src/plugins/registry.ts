 ...
 *
 * Plugins call window.__DIGIT_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__DIGIT_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__DIGIT_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__DIGIT_PLUGIN_SDK__ = {
    ...
    // window.__DIGIT_SESSION_TOKEN__ directly.
    authedFetch,
