"""Session <-> workspace grouping key (digit_state.workspace_key).

The key is what `digit sessions list --workspace` groups/filters on. It is a
...
from digit_state import workspace_key
