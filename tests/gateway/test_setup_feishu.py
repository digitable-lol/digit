"""Tests for _setup_feishu() in digit_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("digit_cli.config.save_env_value", side_effect=mock_save), \
         patch("digit_cli.config.get_env_value", side_effect=mock_get), \
         patch("digit_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("digit_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("digit_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("digit_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("digit_cli.cli_output.print_header"), \
         patch("digit_cli.cli_output.print_info"), \
         patch("digit_cli.cli_output.print_success"), \
         patch("digit_cli.cli_output.print_warning"), \
         patch("digit_cli.cli_output.print_error"), \
