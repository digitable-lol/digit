...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("digit_logging.setup_logging", lambda digit_home, mode: tmp_path)
    monkeypatch.setattr("digit_logging._add_rotating_handler", lambda *args, **kwargs: None)
