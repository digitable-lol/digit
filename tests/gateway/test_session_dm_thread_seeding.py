...
def store(tmp_path, monkeypatch):
    ...
    ~/.digit/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at digit_state import time, before pytest's DIGIT_HOME monkeypatch
    fires — the autouse fixture's DIGIT_HOME override doesn't help here.)
    """
    import digit_state
