...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("DIGIT_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("DIGIT_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("DIGIT_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
