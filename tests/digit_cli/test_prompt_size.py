"""Tests for the ``digit prompt-size`` diagnostic (issue #34667)."""
...
from digit_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(digit_home, memory_text="", user_text=""):
    mem_dir = digit_home / "memories"
...
def _seed_skill(digit_home, name, description):
    skill_dir = digit_home / "skills" / "demo" / name
