"""Tests for the specifier module + `digit kanban specify` CLI surface.
...
from digit_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `digit kanban …` argparse surface directly."""
