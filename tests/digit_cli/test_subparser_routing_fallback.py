...
The main() function in digit_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `digit -c model`
...
def _build_parser():
    """Build a minimal replica of the digit top-level parser."""
