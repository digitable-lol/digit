"""Tests for the interactive session browser (`digit sessions browse`).
...
from digit_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """digit sessions browse should be parseable."""
