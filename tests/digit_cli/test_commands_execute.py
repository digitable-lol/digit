...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`digit_cli.slash_exec.EXECUTORS`, and
...
from digit_cli.commands import COMMAND_REGISTRY, resolve_command
from digit_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
