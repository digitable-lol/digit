"""Tests for `digit curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated DIGIT_HOME with real agent-created skills on disk."""
    home = tmp_path / ".digit"
    skills = home / "skills"
    ...
    from digit_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import digit_cli.curator as curator_cli
