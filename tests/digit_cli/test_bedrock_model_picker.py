...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (DIGIT_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via DIGIT_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in DIGIT_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from digit_cli.providers import DIGIT_OVERLAYS
        assert "bedrock" in DIGIT_OVERLAYS
