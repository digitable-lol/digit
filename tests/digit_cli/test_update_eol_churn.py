"""Regression: ``digit update`` should take a managed checkout off autocrlf=true.
...
``digit update`` has to repair them.
...
from digit_cli.update_cmd import _normalize_managed_eol
