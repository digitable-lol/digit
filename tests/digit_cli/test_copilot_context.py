...
def _clear_cache():
    ...
    import digit_cli.models as mod
...
class TestGetCopilotModelContext:
    ...
    @patch("digit_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("digit_cli.models.fetch_github_model_catalog", return_value=[])
