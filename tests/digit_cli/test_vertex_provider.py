...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (digit_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_digit_overlays():
    """digit_cli.providers.get_provider("vertex") backs
