"""Tests for ``digit approvals suggest`` (digit_cli/approvals_suggest.py).

Approval history in Digit is implied, not ledgered: the session DB
...
from digit_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
