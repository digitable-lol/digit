"""Tests for `digit secrets bitwarden token` / `digit secrets onepassword token`.
...
from digit_cli import onepassword_secrets_cli as op_cli
from digit_cli import secrets_cli as bw_cli
