...
from digit_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/digit_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("digit_cli.lifecycle.invoke_hook")
@patch("digit_cli.lifecycle.finalize_session")
