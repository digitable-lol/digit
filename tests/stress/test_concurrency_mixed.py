...
def worker_loop(worker_id: int, digit_home: str, result_file: str) -> None:
...
def reclaimer_loop(digit_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="digit_mixed_stress_")
    print(f"DIGIT_HOME = {home}")
