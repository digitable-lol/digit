...
The unit tests in tests/digit_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned digit-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/digit")
from digit_cli.service_manager import S6ServiceManager
