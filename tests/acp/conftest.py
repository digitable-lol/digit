...
Keeps the ACP server tests offline: ``DigitACPAgent._build_model_state``
calls ``digit_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import digit_cli.inventory as inventory
