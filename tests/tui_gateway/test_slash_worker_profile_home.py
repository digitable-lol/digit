    ...
    with patch.dict("sys.modules", {
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            worker = _SlashWorker(
                ...
                model="test-model",
                profile_home="/home/luke/.digit/profiles/work"
            )
            
            # Verify Popen was called
            assert mock_popen.called
            
            # Check that DIGIT_HOME was set in the environment
            call_kwargs = mock_popen.call_args[1]
            assert "env" in call_kwargs
            assert call_kwargs["env"]["DIGIT_HOME"] == "/home/luke/.digit/profiles/work"
