...
def _profile_user_agent() -> str:
    """Return a ``digit-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from digit_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"digit-cli/{_ver}"
    except Exception:
        return "digit-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # digit-cli UA so the catalog endpoint is reachable.
