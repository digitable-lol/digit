...
Registry of record: `digit_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Digit config+state snapshots (CLI)
