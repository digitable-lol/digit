/**
 * Digit desktop plugin template. Save as:
 *   <digit home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <digit home> is ~/.digit by default, or ~/.digit/profiles/<name>
 * when running a named profile (`digit -p <name>`). Run `digit doctor` (or
 ...
 * Only these imports resolve: @digit/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@digit/plugin-sdk'
