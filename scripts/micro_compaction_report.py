#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Digit logs.
...
With no LOGFILE, reads ``$DIGIT_HOME/logs/agent.log`` (default ~/.digit).
...
def default_log() -> Path:
    home = os.environ.get("DIGIT_HOME") or str(Path.home() / ".digit")
