#!/usr/bin/env python3
"""Build the Digit Skills Index — a centralized JSON catalog of all skills.
...
`digit skills search/install` can use it without hitting the GitHub API.
...
# Ensure DIGIT_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Digit Skills Index...", flush=True)
