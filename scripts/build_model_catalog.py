#!/usr/bin/env python3
"""Build the Digit Model Catalog — a centralized JSON manifest of curated models.
...
Digit CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Digit release.
...
# Ensure DIGIT_HOME is set for imports that touch it at module level.
os.environ.setdefault("DIGIT_HOME", os.path.join(os.path.expanduser("~"), ".digit"))

from digit_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "digit repo",
            "docs": "https://docs.digitable.life/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Digit '
