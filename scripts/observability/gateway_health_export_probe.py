...
def main() -> None:
    ...
    digit_home = Path(tempfile.mkdtemp(prefix="digit-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "digit-gateway-smoke",
    ...
    print(json.dumps({"digit_home": str(digit_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
