...
Trust levels:
  - builtin:   Ships with Digit. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.digit/\.env|\~/\.digit/\.env',
     "digit_env_access", "critical", "exfiltration",
     "directly references Digit secrets file"),
    ...
    (r'\.digit/config\.yaml|\.digit/SOUL\.md',
     "digit_config_mod", "critical", "persistence",
     "references Digit configuration files directly"),
...
# scan. `.skillignore` is the Digit-native name; `.clawhubignore` is honored
