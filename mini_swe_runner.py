#!/usr/bin/env python3
"""
SWE Runner with Digit Trajectory Format

A runner that uses Digit's built-in execution environments
(local, docker, modal) and outputs trajectories in the Digit format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Digit's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Digit format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Digit format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Digit's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Digit Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Digit's built-in execution environments
    and outputs trajectories in Digit format.
    """
    ...
    def _convert_to_digit_format(
        ...
        """
        Convert internal message format to Digit trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Digit trajectory format
        trajectory = self._convert_to_digit_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Digit trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Digit Trajectory Format")
    print("=" * 60)
