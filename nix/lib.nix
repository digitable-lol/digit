      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via DIGIT_BUNDLED_SKILLS /
            # DIGIT_OPTIONAL_SKILLS (see digit.nix), not via the
            ...
            # __init__.py) shipped via symlinks + DIGIT_BUNDLED_LOCALES
            # / DIGIT_OPTIONAL_MCPS, not via the wheel. Excluding them
