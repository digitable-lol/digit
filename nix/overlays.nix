# nix/overlays.nix — Expose pkgs.digit for external NixOS configs
#
...
# `pkgs.digit`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    digit = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
