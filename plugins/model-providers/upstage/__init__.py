...
# When the user hasn't picked a reasoning effort, Digit passes
...
# ON at this effort — matching the "medium (default)" that Digit' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Digit' effort vocabulary onto Solar's accepted set. xhigh/max/
