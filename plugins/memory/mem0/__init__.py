...
Configuration
-------------
Secret (lives in $DIGIT_HOME/.env or the environment):
...
Behavioral settings (live in $DIGIT_HOME/mem0.json, set via `digit memory
setup`):
  ...
  agent_id           — Agent identifier (default: digit)
...
def _load_config() -> dict:
    """Load config from env vars, with $DIGIT_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "digit"),
        "oss": {},
    }
    ...
    config_path = get_digit_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, digit_home):
        """Write config to $DIGIT_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $DIGIT_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "digit")
