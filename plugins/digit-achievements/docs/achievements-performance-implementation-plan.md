# Digit Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.digit/plugins/digit-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.digit/plugins/digit-achievements/scan_checkpoint.json`.
