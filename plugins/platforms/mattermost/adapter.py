...
required — uses aiohttp which is already a Digit dependency.
...
def interactive_setup() -> None:
    ...
    ``digit_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Digit delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # digit_cli/setup.py::_setup_mattermost function.
