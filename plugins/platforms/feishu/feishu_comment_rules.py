...
Config: ~/.digit/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.digit/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_digit_home()`` helper (DIGIT_HOME-aware and
...
RULES_FILE = get_digit_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_digit_home() / "feishu_comment_pairing.json"
