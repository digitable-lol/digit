...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Digit gateway adapter.

    Each inbound phone number gets its own Digit session (multi-tenant).
...
# static dict in digit_cli/gateway.py, and the _send_sms dispatch in
