...
| 基于模板编辑或创建 | 阅读 [SKILL.md 的「Editing existing decks and templates」一节](https://github.com/digitable-lol/digit/blob/main/skills/productivity/powerpoint/SKILL.md) |
| 从零创建 | 阅读 [SKILL.md 的「Creating with pptxgenjs — gotchas」一节](https://github.com/digitable-lol/digit/blob/main/skills/productivity/powerpoint/SKILL.md) |
...
**完整细节请阅读 [SKILL.md 的「Editing existing decks and templates」一节](https://github.com/digitable-lol/digit/blob/main/skills/productivity/powerpoint/SKILL.md)。**
...
**完整细节请阅读 [SKILL.md 的「Creating with pptxgenjs — gotchas」一节](https://github.com/digitable-lol/digit/blob/main/skills/productivity/powerpoint/SKILL.md)。**
