...
| [**honcho**](/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-honcho) | Configure and troubleshoot Honcho memory for Digit. |
...
| Skill | Description |
|-------|-------------|
| [**digitable-chat**](/user-guide/skills/optional/communication/communication-digitable-chat) | Use to open an ephemeral P2P chat room link for a human. |
...
| [**digit-s6-container-supervision**](/user-guide/skills/optional/devops/devops-digit-s6-container-supervision) | Modify or debug s6 services in the Digit Docker image. |
...
| Skill | Description |
|-------|-------------|
| [**openclaw-migration**](/user-guide/skills/optional/migration/migration-openclaw-migration) | Import an OpenClaw setup (memories, skills) into Digit. |
