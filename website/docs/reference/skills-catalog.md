...
| [`ouroboros-tracing`](/user-guide/skills/bundled/software-development/software-development-ouroboros-tracing) | Записывает, как код на самом деле исполнялся — вызовы, доводы, возвращённые значения, исключения, длительности. Обмазывает исходник на Python, JavaScript/TypeScript, C, C++, Elixir и Go так, что запуск обмазанного кода дописывает по две... | `software-development/ouroboros-tracing` |
