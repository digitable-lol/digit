---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in Digit"
description: "Try NVIDIA Nemotron 3 Ultra on Nous Portal — free June 4–18 — with day 0 support in Digit"
---

# Run Nemotron 3 Ultra free in Digit
...
When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://portal.nousresearch.com) account (or sign in), choose the **Free** plan, and authorize Digit. The app connects automatically.
...
Select **Quick Setup**. Digit opens a browser tab and waits for you to finish the next steps.
...
When prompted to connect your account to Digit, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `digit portal info` confirms you're logged in and routing through Nous.
...
- **[Run Digit with Nous Portal](/guides/run-digit-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
