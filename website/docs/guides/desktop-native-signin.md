...
description: "How the Digit Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Digit Desktop app connects to a **gated gateway** (a hosted or
...
For Digit specifically, native sign-in means:
...
- [Run Digit with Nous Portal](./run-digit-with-nous-portal.md)
