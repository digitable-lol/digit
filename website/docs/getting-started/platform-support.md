...
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **macOS** (Apple Silicon)                                                     | [Homebrew](./installation.md#macos-homebrew), [`install.sh`](./installation.md#linux--macos--wsl2--android-termux)              |
...
| [**Docker Container**](../user-guide/docker.md#quick-start) (x86_64, aarch64) | [`docker compose build`](../user-guide/docker.md#quick-start)                                                                  | Docker installs do not support `digit update`. Updating is done by rebuilding the image.                                                                 |
