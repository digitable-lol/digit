...
If you find a bug, [open an issue](https://github.com/digitable-lol/digit/issues) with the output of `digit logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
