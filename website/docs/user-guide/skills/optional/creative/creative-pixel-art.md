...
| | |
|---|---|
| Source | Optional — install with `digit skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.digit/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.digit/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Digit installs package this)
