...
| | |
|---|---|
| Source | Optional — install with `digit skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Digit |
| License | MIT |
...
Helper script path: `~/.digit/skills/blockchain/evm/scripts/evm_client.py`
