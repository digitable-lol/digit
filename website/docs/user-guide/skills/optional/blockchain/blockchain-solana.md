...
| | |
|---|---|
| Source | Optional — install with `digit skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Digit |
| License | MIT |
...
Helper script path: ~/.digit/skills/blockchain/solana/scripts/solana_client.py
