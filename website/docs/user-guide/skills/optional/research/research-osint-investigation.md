...
| | |
|---|---|
| Source | Optional — install with `digit skills install official/research/osint-investigation` |
...
# $DIGIT_OSINT_CACHE/icij/ (default: ~/.cache/digit-osint/icij/).
...
# Set DIGIT_OSINT_UA=your-app/1.0 (your@email) to identify yourself
