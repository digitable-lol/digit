...
| | |
|---|---|
| Source | Optional — install with `digit skills install official/research/gitnexus-explorer` |
...
| Related skills | [`digit`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-digit), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
