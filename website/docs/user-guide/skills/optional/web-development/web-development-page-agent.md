...
| | |
|---|---|
| Source | Optional — install with `digit skills install official/web-development/page-agent` |
...
- User wants **Digit itself to drive a browser** → use Digit' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
