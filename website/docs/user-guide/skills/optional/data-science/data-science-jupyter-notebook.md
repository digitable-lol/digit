...
| | |
|---|---|
| Source | Optional — install with `digit skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing digit tool access (web_search, file ops). Stateless. |
