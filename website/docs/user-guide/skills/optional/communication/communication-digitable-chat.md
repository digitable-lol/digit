---
title: "Digitable Chat — Use to open an ephemeral P2P chat room link for a human"
sidebar_label: "Digitable Chat"
...
Use to open an ephemeral P2P chat room link for a human.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `digit skills install official/communication/digitable-chat` |
| Path | `optional-skills/communication/digitable-chat` |
| Version | `1.0.1` |
| Author | Digit |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `chat`, `webrtc`, `ephemeral`, `p2p`, `handoff`, `escalation`, `digitable` |
| Related skills | [`digitable-portal`](/user-guide/skills/bundled/productivity/productivity-digitable-portal) |
