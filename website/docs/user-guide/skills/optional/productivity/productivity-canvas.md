...
| | |
|---|---|
| Source | Optional — install with `digit skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Digit"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${DIGIT_HOME:-~/.digit}/.env`:
