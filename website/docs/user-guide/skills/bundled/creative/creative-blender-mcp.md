---
title: "Blender Mcp — Drive Blender over MCP to model, render and export 3D assets — including headless on a server with no GPU"
sidebar_label: "Blender Mcp"
description: "Drive Blender over MCP to model, render and export 3D assets — including headless on a server with no GPU"
---
...
Drive Blender over MCP to model, render and export 3D assets — including headless on a server with no GPU. Use when the task involves Blender, .blend files, GLB/glTF export, procedural geometry, 3D game assets, renders, or the blender-mcp addon.
...
| Path | `skills/creative/blender-mcp` |
| Version | `1.0.0` |
| Author | Digitable |
| License | MIT |
