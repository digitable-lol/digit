---
title: "Verified Answers — Use when an answer must be traceable to a source rather than generated — Digit's verified mode"
sidebar_label: "Verified Answers"
description: "Use when an answer must be traceable to a source rather than generated — Digit's verified mode"
---
...
| Path | `skills/autonomous-ai-agents/verified-answers` |
| Version | `1.0.0` |
| Author | Digitable |
| License | MIT |
