...
Set your Tenor API key in your environment (add to `${DIGIT_HOME:-~/.digit}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/digitable-lol/digit/blob/main/skills/media/gif-search/url)`
