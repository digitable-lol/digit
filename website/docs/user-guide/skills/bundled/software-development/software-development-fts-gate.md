---
title: "Fts Gate — Use when an FTS specification must be certified before it drives a consequential decision"
sidebar_label: "Fts Gate"
description: "Use when an FTS specification must be certified before it drives a consequential decision"
---
...
| Path | `skills/software-development/fts-gate` |
| Version | `1.0.0` |
| Author | Digitable |
| License | Apache-2.0 |
