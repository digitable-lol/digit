#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Digit docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Digit as a Python Library", None),
        ("guides/use-mcp-with-digit", "Use MCP with Digit", None),
        ("guides/use-voice-mode-with-digit", "Use Voice Mode with Digit", None),
        ("guides/use-soul-with-digit", "Use SOUL.md with Digit", None),
        ("guides/build-a-digit-plugin", "Build a Digit Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Digit"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Digit — Full Documentation\n",
        (
            "This file is the entire Digit documentation concatenated for LLM "
