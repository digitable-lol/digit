...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``digit logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Digit only initiates compaction in "digit" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Digit preflight compression for codex app-server "
                "(mode=%s); Digit will not start thread compaction here.",
