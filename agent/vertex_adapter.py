"""Vertex AI (Google Cloud) adapter for Digit.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Digit to use Gemini models via Google Cloud with
...
# who installed plain `digit` and only later selected a Gemini model.
try:
