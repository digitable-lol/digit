...
_SESSION_CWD: ContextVar = ContextVar("DIGIT_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Digit
    # source tree itself, which is a legitimate workspace when the user is
    # developing Digit (per-surface policy for fallback-picked directories
