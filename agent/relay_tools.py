"""Core NeMo Relay adapter for Digit tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Digit tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Digit Relay tool execution cannot run on an active event-loop thread"
    )
