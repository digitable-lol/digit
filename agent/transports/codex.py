...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Digit's web-provider config and
        ...
        # native search engine for xAI sessions instead of Digit's
        # configured web provider (Tavily/etc.), and those results bypass
        # Digit's tool-trace / citation plumbing (they arrive baked into the
