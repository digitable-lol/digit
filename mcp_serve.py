...
def _get_sessions_dir() -> Path:
    ...
    try:
        ...
        return Path(os.environ.get("DIGIT_HOME", Path.home() / ".digit")) / "sessions"
...
def _load_channel_directory() -> dict:
    ...
    try:
        ...
        directory_file = Path(
            os.environ.get("DIGIT_HOME", Path.home() / ".digit")
...
class EventBridge:
    ...
    def _establish_baseline(self) -> None:
        ...
        try:
            ...
            db_file = Path(os.environ.get("DIGIT_HOME", Path.home() / ".digit")) / "state.db"
        try:
