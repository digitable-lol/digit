"""
Skills configuration for Digit.
`digit skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.digit/config.yaml under:
...
from digit_cli.config import cfg_get, load_config, save_config
from digit_cli.colors import Colors, color
from digit_cli.platforms import PLATFORMS as _PLATFORMS
