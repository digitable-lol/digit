"""Relay subscriber for the persisted Digit shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Digit counters from Relay lifecycle events."""
    ...
    def __init__(
        ...
        *,
        ...
        self.store = store
        self._digit_version = digit_version or "unknown"
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Digit shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
