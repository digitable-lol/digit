"""
Digit CLI - Unified command-line interface for Digit.

Provides subcommands for:
- digit chat          - Interactive chat (same as ./digit)
- digit gateway       - Run gateway in foreground
- digit gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `digit setup` on a fresh Pi.
    ...
    digit_cli/stdio.py::configure_windows_stdio() runs later from the entry
