"""Digit skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Digit itself) customize the
visual appearance across the CLI, the TUI, and the desktop GUI from a single
file. Skins are defined as YAML files in ~/.digit/skins/ or as built-in presets.
...
``resolve_skin`` / ``skin.changed``). A skin dropped in ~/.digit/skins/ therefore
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Digit"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Digit "       # Response box header label
...
.. code-block:: python
    ...
    from digit_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Digit"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.digit/skins/
...
Drop a YAML file in ``~/.digit/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces DIGIT_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces DIGIT_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Digit — gold and kawaii",
        # Dark-authored. Values match the TUI's DARK_THEME so the classic CLI
        # and the TUI render the same Digit gold.
        "colors": {
        ...
        "branding": {
            "agent_name": "Digit",
            "welcome": "Welcome to Digit! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
    ...
    "digitable": {
        "name": "digitable",
        "description": "Digitable Focus — dark canvas, cyan signal, quiet technical contrast",
        "colors": {
            "banner_border": "#21748B",
            "banner_title": "#00E5E5",
            "banner_accent": "#00D8FF",
            "banner_dim": "#64717E",
            "banner_text": "#F5F7FA",
            "ui_accent": "#00E5E5",
            "ui_label": "#00D8FF",
            ...
            "prompt": "#F5F7FA",
            "input_rule": "#21748B",
            "response_border": "#00E5E5",
            "status_bar_bg": "#071018",
            "status_bar_text": "#9BAAB8",
            "status_bar_strong": "#00E5E5",
            "status_bar_dim": "#64717E",
            "status_bar_good": "#7CFF6B",
            "status_bar_warn": "#FFC247",
            "status_bar_bad": "#FF8A2A",
            "status_bar_critical": "#FF5B5B",
            "session_label": "#00D8FF",
            "session_border": "#21748B",
            "completion_menu_bg": "#071018",
            "completion_menu_current_bg": "#0B2732",
            "selection_bg": "#103A49",
            "shell_dollar": "#00E5E5",
            "voice_status_bg": "#071018",
        },
        "light_colors": {
            "banner_border": "#15566A",
            "banner_title": "#007C86",
            "banner_accent": "#006B78",
            "banner_dim": "#5A6874",
            "banner_text": "#071018",
            "ui_accent": "#007C86",
            "ui_label": "#006B78",
            ...
            "prompt": "#071018",
            "input_rule": "#4D8796",
            "response_border": "#007C86",
            "status_bar_bg": "#EEF7F8",
            "status_bar_text": "#32434E",
            "status_bar_strong": "#007C86",
            "status_bar_dim": "#667680",
            "status_bar_good": "#287A1F",
            "status_bar_warn": "#9A6100",
            "status_bar_bad": "#A94F00",
            "status_bar_critical": "#B4232C",
            "session_label": "#006B78",
            "session_border": "#4D8796",
            "completion_menu_bg": "#F5F7FA",
            "completion_menu_current_bg": "#C4E4E8",
            "selection_bg": "#C7E6EA",
            "shell_dollar": "#007C86",
            "voice_status_bg": "#EEF7F8",
        },
        "spinner": {
            "waiting_faces": ["(d)", "(◇)", "(·)", "(⌁)", "(d)"],
            "thinking_faces": ["(d)", "(◇)", "(⌁)", "(·)", "(d)"],
            "thinking_verbs": [
                "mapping the task", "checking the portal", "connecting the pieces",
                "testing the path", "building the answer",
            ],
            "wings": [["‹", "›"], ["«", "»"], ["⟨", "⟩"], ["·", "·"]],
        },
        "branding": {
            "agent_name": "Digit",
            "welcome": "Digit is ready. Напишите по-русски или in English — /help shows commands.",
            "goodbye": "До встречи — Digit by Digitable.",
            "response_label": " ◇ Digit ",
            "prompt_symbol": "›",
