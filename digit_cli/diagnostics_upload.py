"""Client for uploading ``digit debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``digit debug share``.
...
NAS_BASE = os.environ.get(
    "DIGIT_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
