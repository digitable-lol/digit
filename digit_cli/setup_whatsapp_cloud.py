...
Entry point: ``digit whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``digit_cli/main.py``).
...
Digit gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Digit to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Digit needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Digit gateway in another terminal:")
    print("         digit gateway")
    print()
    ...
    print()
    print("  Docs: https://docs.digitable.life/user-guide/")
